    ...
    if (typeof callback != 'undefined') {
      ...
      Skhf.session.sync(function() {
        ...
        if (!$('.modal .modal-header p').length) {
          $('.modal .modal-header').append('<p><b>Votre compte en 1 clic <i class="icon-question-sign" data-content="Enregistez votre compte et retrouvez vos playlists à tout moment. &lt;br/&gt;mySkreen est gratuit et le restera !" data-placement="right" data-trigger="hover" data-original-title="Replay, VOD et cinéma dans une même playlist"></i></b><br/>Créez vos playlists et ne ratez plus vos programmes préférés : Cinéma, TV, Replay et VOD !</p>');
        }
  ...
  togglePlaylist: function(trigger, with_related){
    ...
    if (Skhf.session.datas.email) {
      ...
      this.auth(function(){
        ...
        $('.modal .modal-header').append('<p><b>Vos playlists <i class="icon-question-sign" data-content="Enregistez votre compte et retrouvez vos playlists à tout moment. &lt;br/&gt;mySkreen est gratuit et le restera !" data-placement="right" data-trigger="hover" data-original-title="Replay, VOD et cinéma dans une même playlist"></i></b><br/>' + self.getPlaylistMessage(trigger) + '</p>');
        if (Skhf.session.datas.email) {
